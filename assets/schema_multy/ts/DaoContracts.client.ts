...
export interface DaoContractsReadOnlyInterface {
  ...
  delegationModule: () => Promise<NullableAddr>;
...
export class DaoContractsQueryClient implements DaoContractsReadOnlyInterface {
  ...
  delegationModule = async (): Promise<NullableAddr> => {
    return this.client.queryContractSmart(this.contractAddress, {
      delegation_module: {}
    });
  };
...
export interface DaoContractsInterface extends DaoContractsReadOnlyInterface {
  contractAddress: string;
  sender: string;
  propose: ({
    choices,
...
export class DaoContractsClient extends DaoContractsQueryClient implements DaoContractsInterface {
  ...
  constructor(client: ISigningCosmWasmClient, sender: string, contractAddress: string) {
    ...
    this.updateDelegationModule = this.updateDelegationModule.bind(this);
