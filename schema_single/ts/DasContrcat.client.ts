...
export class DasContrcatQueryClient implements DasContrcatReadOnlyInterface {
...
export interface DasContrcatInterface extends DasContrcatReadOnlyInterface {
  contractAddress: string;
  sender: string;
  propose: ({
    description,
...
export class DasContrcatClient extends DasContrcatQueryClient implements DasContrcatInterface {
